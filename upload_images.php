...
?>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
					<div class="form-row">
						<form method="POST" enctype="multipart/form-data"  action="uploadi.php" autocomplete="OFF">
					  <div class="form-group">
						...
						?>
						<label for="exampleFormControlFile1"><b>Silahkan Upload Gambar Anda</b></label>
				  	    <div class="form-group col-md-12">
					      <input type="text" class="form-control" placeholder="Beri Nama File" name="nama">
					    </div>
					  	<div class="form-group col-md-12">
